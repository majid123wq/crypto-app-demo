  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', background: '#0a0b0d', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', color: '#6b7280', fontFamily: "'Syne', sans-serif" }}>
          <div style={{
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto' }}>
        ...
        {error && (
          <div style={{
            ...
            color: '#ef4444', fontFamily: "'Syne', sans-serif", fontSize: '14px',
          }}>{error}</div>
        )}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <h1 style={{
                ...
                fontWeight: '800', color: '#f9fafb', margin: '0 0 6px',
              }}>{displayData?.name}</h1>
              ...
              <span style={{
                ...
                color: '#3b82f6', padding: '3px 10px', borderRadius: '20px',
                fontSize: '11px', fontFamily: "'Syne', sans-serif", fontWeight: '600',
                textTransform: 'uppercase', letterSpacing: '0.06em',
              }}>{displayData?.role || 'User'}</span>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          {[
            ...
            { label: 'Member Since', value: formatDate(displayData?.createdAt) },
            { label: 'Last Updated', value: formatDate(displayData?.updatedAt) },
          ].map(item => (
            <div key={item.label} style={{
              ...
              <span style={{ color: '#6b7280', fontSize: '13px', fontFamily: "'Syne', sans-serif" }}>
                {item.label}
              </span>
              <span style={{
                color: '#f9fafb', fontSize: '13px',
                fontFamily: item.mono ? "'Courier New', monospace" : "'Syne', sans-serif",
